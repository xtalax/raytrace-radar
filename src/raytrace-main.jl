...
for t in 0:nTheta-1
    ...
    detector = Detector(Point(bundleOrigin - bundleDirection/10),Point(bundleDirection)) # using default values - see raytracer-types for more
    ...
    @time Sf,Pf = freqsweep(detector,freqs)
